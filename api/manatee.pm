...
*loadCorpInfo = *manateec::loadCorpInfo;
...
*collocs = *manateec::RangeStream_collocs;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*dynid2srcids = *manateec::PosAttr_dynid2srcids;
*regexp2poss = *manateec::PosAttr_regexp2poss;
*regexp2ids = *manateec::PosAttr_regexp2ids;
*freq = *manateec::PosAttr_freq;
*docf = *manateec::PosAttr_docf;
*arf = *manateec::PosAttr_arf;
*aldf = *manateec::PosAttr_aldf;
...
*compile_frq = *manateec::Corpus_compile_frq;
*compile_arf = *manateec::Corpus_compile_arf;
*compile_aldf = *manateec::Corpus_compile_aldf;
*compile_docf = *manateec::Corpus_compile_docf;
...
*coll_beg_at = *manateec::Concordance_coll_beg_at;
*coll_end_at = *manateec::Concordance_coll_end_at;
...
*delete_subparts = *manateec::Concordance_delete_subparts;
*delete_struct_repeats = *manateec::Concordance_delete_struct_repeats;
sub new {
    my $pkg = shift;
...
############# Class : manatee::CorpInfo ##############

package manatee::CorpInfo;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( manatee );
%OWNER = ();
%ITERATORS = ();
*dump = *manateec::CorpInfo_dump;
*add_attr = *manateec::CorpInfo_add_attr;
*add_struct = *manateec::CorpInfo_add_struct;
*set_opt = *manateec::CorpInfo_set_opt;
*find_opt = *manateec::CorpInfo_find_opt;
sub new {
    my $pkg = shift;
    my $self = manateec::new_CorpInfo(@_);
    bless $self, $pkg if defined($self);
}
