...
public class manatee {
  ...
  public static boolean create_subcorpus(String subcpath, RangeStream r) {
    return manateeJNI.create_subcorpus__SWIG_1(subcpath, RangeStream.getCPtr(r), r);
  }

  public static boolean create_subcorpus(String subcpath, Corpus corp, String structname, String query) {
    return manateeJNI.create_subcorpus__SWIG_2(subcpath, Corpus.getCPtr(corp), corp, structname, query);
  }
  ...
  public static CorpInfo loadCorpInfo(String corp_name_or_path) {
    long cPtr = manateeJNI.loadCorpInfo(corp_name_or_path);
