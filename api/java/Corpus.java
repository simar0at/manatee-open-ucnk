...
public class Corpus {
  ...
  public Corpus(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(Corpus obj) {
  ...
  public long compute_docf(FastStream poss, RangeStream struc) {
    return manateeJNI.Corpus_compute_docf(swigCPtr, this, FastStream.getCPtr(poss), poss, RangeStream.getCPtr(struc), struc);
  }
  ...
  public double count_ARF(FastStream s, long freq) {
    return manateeJNI.Corpus_count_ARF(swigCPtr, this, FastStream.getCPtr(s), s, freq);
  }
